...
export class EcsRoutingStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: EcsRoutingStackProps) {
    ...
    const alb2 =
      elasticloadbalancingv2.ApplicationLoadBalancer.fromApplicationLoadBalancerAttributes(
        this,
        "workshop-alb",
        {
    ...
    listener.addEndpointGroup("workshop-group02", {
      ...
      endpoints: [
        new globalaccelerator_endpoints.ApplicationLoadBalancerEndpoint(alb2, {
    ...
    new CfnOutput(this, "GlobalAcceleratorDNS", {
